...
def oilInputFunc():
 #oilFunc = True:
 print('#######################################################################')
 print('\n  This program will generate information about oil prices and \n\
       number of oil contracts')
 print('  Now you only have four options to procede in this process: \n')
 print('\n  (1) Please type in 1 if you would like to access text file containing \n\
       information about oil prices and number of oil contracts on \n\
       correspondent dates')
 print('\n  (2) Type in 2 if you would like to access info about minimum oil price')
 print('\n  (3) Type in 3 if you would like to access info about oil prices on \n\
       specific dates')
 print('\n  (4) Insert Enter or empt space inorder to Exit the menu\n\n')      
 print('#######################################################################')
